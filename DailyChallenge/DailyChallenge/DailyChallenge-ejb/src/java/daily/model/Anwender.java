...
@NamedQueries(
{
    ...
    @NamedQuery(name = "Anwender.findByName", query = "SELECT a FROM Anwender a WHERE a.username = :username"),
    ...
    @NamedQuery(name = "Anwender.deleteUser", query = "DELETE FROM Anwender a WHERE a.username = :username")
})
